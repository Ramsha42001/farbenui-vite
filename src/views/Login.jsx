...
const Login = () => {
  ...
  const { error, user ,isAuthenticated,loading} = useSelector((state) => state.auth); // Assuming you store user data in state.auth
        ...
        >
          ...
          <div className="flex items-center mb-4">
            <img
              src={logo}
              alt="Logo"
              style={{ width: '70px', height: '70px', marginRight: '8px', marginTop: '-10px' }}
            />
            <Typography
              variant="h2"
              component="span"
